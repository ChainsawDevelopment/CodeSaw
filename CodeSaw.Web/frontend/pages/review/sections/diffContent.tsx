...
export default connect(
    ...
    (dispatch: Dispatch) => ({
        startFileDiscussion: (fileId, lineNumber, content, type, currentUser) =>
            dispatch(startFileDiscussion({ fileId, lineNumber, content, type, currentUser })),
    ...
    (stateProps: StateProps, dispatchProps, ownProps: OwnProps): Props => ({
        ...
        ...dispatchProps,
        ...ownProps,
        startFileDiscussion: (path, lineNumber, content, type) =>
            dispatchProps.startFileDiscussion(path, lineNumber, content, type, stateProps.currentUser),
        commentActions: {
