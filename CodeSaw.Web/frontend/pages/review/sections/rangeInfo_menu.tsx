...
export const FileNavigation = (props: { reviewId: ReviewId; prevFile: FileToReview; nextFile: FileToReview; }): JSX.Element => {
...
export const FilePath = (props: { path: PathPair }): JSX.Element => <Menu.Item fitted key="file-path">
...
export const OpenVSCode = (props: { workspace: string; path: PathPair }): JSX.Element => {
    ...
    return <Menu.Item fitted key="vscode-diff">
        <Popup
            trigger={
                <img src={vscodeLogo} className="vscode-icon" onClick={() => window.open(`vscode://file/${workspacePath}/${props.path.newPath}`)} />
            }
