    ...
    return (
        <div
            className={classNames({
                'read-only': props.discussion.state === DiscussionState.Resolved,
                'good-work': props.discussion.state === DiscussionState.GoodWork,
            })}
        >
            <CommentComponent
...
export default class CommentsComponent extends React.Component<DiscussionsProps, CommentsState> {
    ...
    render(): JSX.Element {
        ...
        return (
            <UIComment.Group>
                <Header as="h3">{this.props.title || 'Comments'}</Header>
                {discussions}
